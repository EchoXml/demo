			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="index.html"><i class="fa fa-circle-o"></i>
									仪表盘 v1</a></li>
							<li><a href="/SsmDemo/adminlte/index2"><i
									class="fa fa-circle-o"></i> 仪表盘 v2</a></li>
						</ul></li>
					<!-- 用户信息管理 -->
					...
					<li class="active treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li class="active"><a href="<%=basePath%>adminlte/bookList"><i
				...
				<form action="<%=basePath%>book/addBook.do" method="post">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="exampleModalLabel">新增图书</h4>
						</div>
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="number" min="1" required="required"></input>
							</div>
