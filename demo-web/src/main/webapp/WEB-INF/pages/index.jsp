...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<%=basePath%>page/index" class="logo">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>注册日期  ${sessionScope.currUser.createDateStr }</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li><a href="#sales-chart" data-toggle="tab">面包圈</a></li>
              <li class="pull-left header"><i class="fa fa-inbox"></i> 访客记录</li>
            </ul>
            ...
            <div class="box-footer no-border">
              <div class="row">
                ...
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">在线订单</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
                  <input type="text" class="knob" data-readonly="true" value="30" data-width="60" data-height="60" data-fgColor="#39CCCC">

                  <div class="knob-label">商店订单</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016-2018 <a href="http://zecho.top">Echo</a>.</strong> All rights
    reserved.
  </footer>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <!-- /.tab-pane -->
      <!-- Stats tab content -->
      <div class="tab-pane" id="control-sidebar-stats-tab">统计数据选项卡内容</div>
      <!-- /.tab-pane -->
      <!-- Settings tab content -->
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          <h3 class="control-sidebar-heading">通用设置s</h3>
