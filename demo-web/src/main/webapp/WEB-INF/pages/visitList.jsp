...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<shiro:hasAnyRoles name="admin,superadmin">
					        <li class="active treeview">
					          ...
					          <ul class="treeview-menu">
								...
								<ul class="treeview-menu">
									<li class="active"><a href="<%=basePath%>page/visitlist"><i class="fa  fa-user-secret"></i> 访客信息</a></li>
								</ul>
					          </li>
						</shiro:hasAnyRoles>
					<!-- 图书信息管理 -->
	...
	<script>
	$(function() {
	    $.get("<%=basePath%>system/ajax/getVisits", function(data) {
				...
				var t = $("#userTable").DataTable({
					...
					"columnDefs" : [ {
						...
						"render": function(data, type, row, meta) {
							var result=getMyDate(data.visitTime);
							console.log(result);
							return result;
						}
					}],
