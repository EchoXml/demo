...
/*	@RequestMapping(value = "/list", method = RequestMethod.GET)
	public String list(Model model){
        ...
        return "bookList.jsp";// WEB-INF/jsp/"list".jsp
	}
	*/
	...
	private ModelAndView addBook(String name,int number){
		...
		m.setViewName("forward:/adminlte/bookList");
		return m;
    ...
    @ResponseBody
    private Result<DelStateEnum> del(@PathVariable("bookId") Long bookId,HttpSession session) {
